...
class StartScreen:
    def __init__(self):
        self.background = pygame.image.load('pic2/b1.png').convert()
        self.start_button = pygame.image.load('pic2/start_button(1).png').convert_alpha()
        self.exit_button = pygame.image.load('pic2/exit_button(1).png').convert_alpha()  # You'll need to create this image

        # Position buttons
        self.start_rect = self.start_button.get_rect(center=(450, 300))
        self.exit_rect = self.exit_button.get_rect(center=(450, 400))
...
def __init__(self):
    self.current_bg = 0
    self.background = pygame.image.load(self.background_images[self.current_bg]).convert()
    self.button = pygame.image.load(self.start_button).convert_alpha()
    self.button_rect = self.button.get_rect(center=(450, 450))
...
def next_background(self):
    """切换到下一张背景图片"""
    self.current_bg = (self.current_bg + 1) % len(self.background_images)
    self.background = pygame.image.load(self.background_images[self.current_bg]).convert()
...
class Tree(pygame.sprite.Sprite):
    ...
    energy_num = 'pic2/energy_num(1).png'  # 精力
    ...
    energy_num_position = (10, 200)  # 精力坐标
...
class ManagerTree:
    ...
    def draw_tree(self, energy_num, money_num):
        ...
        if energy_num > 30:
            self.load_text(str(30) + '/30', (22, 55), 25)
        else:
            self.load_text(str(energy_num)+'/30', (22, 55), 25)
        # print("money", money_num)
        Tree(Tree.money, (15, 200)).draw(self.screen)  # 画银币
        self.load_text(str(money_num), (30, 204), 21)
...
class Board(pygame.sprite.Sprite):
    ...
    ok = 'pic2/ok.png'    # ok勾
    # 关数板子
    levelBoard = ('pic2/level1.png' ,'pic2/level0.png' ,'pic2/level2.png', 'pic2/level3.png', 'pic2/level4.png', 'pic2/level5.png',
